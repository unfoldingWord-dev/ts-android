...
public class ServerLibraryDetailFragment extends TranslatorBaseFragment implements ManagedTask.OnFinishedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // tabs
        mHolder.mTabsAdapter.addTab(getResources().getString(R.string.languages), LanguagesTab.class, getArguments());
        // TODO: only display if there are drafts
        mHolder.mTabsAdapter.addTab(getResources().getString(R.string.drafts), TranslationDraftsTab.class, getArguments());
...
//            }
            ...
            LanguagesTab languagesTab = (LanguagesTab) mHolder.mTabsAdapter.getFragmentForPosition(0);
            ...
            TranslationDraftsTab draftsTab = (TranslationDraftsTab) mHolder.mTabsAdapter.getFragmentForPosition(1);
            if (draftsTab != null) {
