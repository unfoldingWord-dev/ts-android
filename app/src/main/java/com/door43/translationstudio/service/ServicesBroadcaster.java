 ...
 */
public class ServicesBroadcaster extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startid) {
        ...
        final int udpPort = 9939;
        final int serviceTCPPort = 0;
        final int broadcastFrequency = 1000;
        PackageInfo pInfo;
        try {
        ...
        String data = "tS:" + pInfo.versionCode + ":" + serviceTCPPort;
